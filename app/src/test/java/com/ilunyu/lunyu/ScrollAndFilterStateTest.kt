...
class ScrollAndFilterStateTest {
    ...
    fun testExerciseFilterChipLabels() {
        ...
        assertEquals("2 个学年", getYearChipLabel(setOf("2023", "2024")))

        // 地区
        assertEquals("地区", getSourceChipLabel(emptySet<String>()))
        assertEquals("东城", getSourceChipLabel(setOf("东城")))
        assertEquals("3 个地区", getSourceChipLabel(setOf("东城", "西城", "海淀")))
        ...
        assertEquals("2 个年级", getGradeChipLabel(setOf(1, 2)))
        ...
        assertEquals("4 类试卷", getTypeChipLabel(setOf("期末", "期中", "模拟", "练习")))
    }
